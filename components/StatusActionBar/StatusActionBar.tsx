      ...
      <View style={styles.container}>
        <View style={styles.actions}>
          <TouchableOpacity
            ...
            accessibilityHint="Opens the reply drawer"
          >
            <CustomIcon
          ...
          <TouchableOpacity
            ...
            accessibilityHint="Toggle favorite for this status"
          >
            <CustomIcon
              name="HeartIcon"
              solid={isFavorited}
          ...
          <TouchableOpacity
            ...
            accessibilityHint="Toggle reblog for this status"
          >
            <CustomIcon
              name="ArrowPathIcon"
              solid={isReblogged}
          ...
          <TouchableOpacity
            ...
            accessibilityHint="Toggle bookmark for this status"
          >
            <CustomIcon
              name="BookmarkIcon"
              solid={isBookmarked}
        ...
        <TouchableOpacity
          ...
          accessibilityHint="Opens more options for this status"
        >
